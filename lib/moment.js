...
// (function (undefined) {
    ...
    ************************************/
    ...
    import { deprecate, deprecateSimple } from "./utils/deprecate";

    import { getParseRegexForToken, matchOffset } from "./parse/regex";
    import { addTimeToArrayFromToken }            from "./parse/token";

    import { formatMoment, expandFormat, formatTokenFunctions } from "./format/format";

    import { copyConfig, Moment, momentProperties, checkOverflow } from "./constructors/moment";
    import { makeDate, makeUTCDate }                               from "./constructors/date";
    import { Duration }                                            from "./constructors/duration";

    import { daysInMonth }                          from "./units/month";
    import { weekOfYear }                           from "./units/week";
    import { dayOfYearFromWeeks }                   from "./units/day-of-year";
    import { isLeapYear, daysInYear }               from "./units/year";
    import { offsetFromString, cloneWithOffset }    from "./units/offset";
    ...
    function makeList(field) {
        ...
        moment[field] = function (format, index) {
            ...
            getter = function (i) {
                ...
                return method.call(locale, m, format || '');
            };
